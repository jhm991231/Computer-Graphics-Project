...
function arm(side, shoulderZ, shoulderXZ, elbow, customSX) {
  ...
  mat4.rotate(stk.current, stk.current, shoulderXZ, [1, 0, 0]);
  mat4.rotate(stk.current, stk.current, shoulderZ, [0, 0, 1]);
  // shoulder sphere
  stk.push();
